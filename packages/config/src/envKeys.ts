...
export const EnvKeys = {
  ...
  // ── Vendor cost sync (Phase 3) ────────────────────────────────────────────
  AZURE_SUBSCRIPTION_ID: 'AZURE_SUBSCRIPTION_ID',
  AZURE_TENANT_ID: 'AZURE_TENANT_ID',
  AZURE_CLIENT_ID: 'AZURE_CLIENT_ID',
  AZURE_CLIENT_SECRET: 'AZURE_CLIENT_SECRET',
  /** Base64-encoded Google Cloud service account key JSON. Never log. */
  GOOGLE_SERVICE_ACCOUNT_KEY_B64: 'GOOGLE_SERVICE_ACCOUNT_KEY_B64',
  /** Google Cloud billing account ID, e.g. billingAccounts/XXXXXX-XXXXXX-XXXXXX */
  GOOGLE_CLOUD_BILLING_ACCOUNT_ID: 'GOOGLE_CLOUD_BILLING_ACCOUNT_ID',
  VENDOR_SYNC_TIMER_DISABLED: 'VENDOR_SYNC_TIMER_DISABLED',
  VENDOR_SYNC_TIMER_CRON: 'VENDOR_SYNC_TIMER_CRON',
} as const;
