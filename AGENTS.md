...
- **Dark preview without the flag:** open **`/dark`** (same content as home) to force dark styling for local testing; use the header appearance menu to exit preview (navigate home).
