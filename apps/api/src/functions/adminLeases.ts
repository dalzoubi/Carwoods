...
async function adminLeasesCollection(
  request: HttpRequest,
...
async function adminLeasesItem(
  request: HttpRequest,
  _context: InvocationContext
): Promise<HttpResponseInit> {
  const gate = await requireAdmin(request);
...
app.http('adminLeasesCollection', {
  methods: ['GET', 'POST', 'OPTIONS'],
  authLevel: 'anonymous',
  route: 'admin/leases',
  handler: adminLeasesCollection,
});

app.http('adminLeasesItem', {
  methods: ['GET', 'PATCH', 'DELETE', 'OPTIONS'],
  authLevel: 'anonymous',
  route: 'admin/leases/{id}',
  handler: adminLeasesItem,
});
